...
BOT_TOKEN = environ.get('BOT_TOKEN', '7636096302:AAEEmpc-Qb8NwxroNBfuz7wFquhBYjJycRk')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Only_movies_searching_group')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001902019959').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://washeyare:pYyuC1yMJG98P7Tj@cluster0.3iw76.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "washeyare")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/onyl_Bots') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/oEE.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/oEE.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/oEu.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡", "🥳"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
